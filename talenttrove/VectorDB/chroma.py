...
for index, row in df.iterrows():
    ...
    metadatas.append({'company_name': company_name, 'company_logo': company_logo, 'job_post_id': job_post_id, 'title':title, 'apply_url':apply_url, 'date':date, 'jobtype':jobtype})
